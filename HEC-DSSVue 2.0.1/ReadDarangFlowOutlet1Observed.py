...
#  Open the Siron.dss file with a string that represents the time window
  dssFile = HecDss.open("C:\Users\Dragos\Desktop\dizertatie\Darang\Run_1.dss", "01JUN2014 0000, 02JUN2014 0600")
...
# The dataset is in a TimeSeriesContainer object named outflowTS 
  outflowTS = dssFile.get("//OUTLET1/FLOW-OBSERVED/01MAY2014/30MIN/RUN:RUN 1/")
